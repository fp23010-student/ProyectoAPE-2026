...
--
-- Servidor: localhost
-- Tiempo de generación: 28-05-2026 a las 05:32:58
...
(001, 'NACHOS SUPREMOS', 'Totopos crujientes con queso fundido, frijoles refritos, guacamole, crema y jalapeños.', 6.50, 01),
(002, 'QUESADILLA DE QUESO OAXACA', 'Tortilla de harina grande rellena de puro queso Oaxaca derretido, acompañada de pico de gallo.', 4.25, 01),
(003, 'ORDEN DE TACOS AL PASTOR', '3 tacos en tortilla de maíz con carne al pastor, piña, cilantro y cebolla.', 5.50, 02),
(004, 'ORDEN DE TACOS DE ASADA', '3 tacos en tortilla de maíz con carne de res asada, cilantro y cebolla picada.', 5.75, 02),
(005, 'ORDEN DE TACOS DE BIRRIA', '3 tacos de birria de res con queso derretido, acompañados de su consomé caliente.', 6.95, 02),
(006, 'BURRITO CALIFORNIANO RELLENO', 'Tortilla gigante con carne de res, arroz, frijoles, queso, aguacate y aderezo de la casa.', 6.25, 02),
(007, 'HORCHATA MEXICANA (VASO)', 'Bebida tradicional de arroz con un toque de canela y vainilla, refrescante.', 1.75, 03),
(008, 'AGUA DE JAMAICA (PICHEL)', 'Pichel de refresco natural de flor de Jamaica, ideal para compartir.', 4.50, 03),
(009, 'SODA LATA', 'Variedad de gaseosas en lata (Coca-Cola, Tropical, Sprite).', 1.50, 03),
(010, 'CHURROS TRADICIONALES', '3 churros crujientes espolvoreados con azúcar y canela, acompañados de cajeta.', 3.50, 04),
(011, 'FLAN NAPOLITANO CASERO', 'Porción de flan cremoso bañado en caramelo artesanal.', 2.75, 04),
(012, 'PORCION DE GUACAMOLE', 'Aguacate fresco machacado con limón, cilantro y un toque de sal.', 1.50, 05),
